...
export const TRACKS = {
  ...
  burpee_ladder: {
    ...
    kind: 'ladder', reset: 0, winsNeeded: 2, fixedRest: true,
    steps: [
      { ladders: 1, rungs: [5, 4, 3, 2, 1], rest: 20 },
      { ladders: 2, rungs: [5, 4, 3, 2, 1], rest: 20 },
      { ladders: 3, rungs: [5, 4, 3, 2, 1], rest: 15, label: 'три круга подряд' }
    ]
  },
  ...
  soju_tuba: {
    kind: 'reps', reset: 0, winsNeeded: 1, noPair: true,
    steps: [
...
export const PROGRAMS = {
  ...
  vwc: {
    ...
    tag: 'потолок по кислороду · 20–40 мин',
