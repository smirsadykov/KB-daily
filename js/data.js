...
export const EXERCISES = {
  ...
  abc: {
    name: 'Комплекс ABC (заброс + жим + 2 приседа)',
    short: 'ABC',
    kind: 'grind', pattern: 'complex', side: 'each',
    load: 'grind',
    cues: [
      'Один круг = заброс, жим, 2 фронтальных приседа. Потом другая сторона.',
      'Работай в минуту: круг + отдых до конца минуты.',
...
export const PROGRAMS = {
  ...
  abc_plan: {
    ...
    tag: 'плотно · 20 мин',
    desc: 'Заброс + жим + 2 приседа в минуту. Много работы за короткое время, хорошо жжёт жир.',
